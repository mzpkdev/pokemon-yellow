...
DEF TM01 EQU const_value
	...
	add_tm PAY_DAY      ; $D8
	add_tm SUPERPOWER   ; $D9
	add_tm COUNTER      ; $DA
	add_tm SEISMIC_TOSS ; $DB
	add_tm DRAIN_PUNCH  ; $DC
...
DEF HORN_DRILL_TMNUM  EQU DRILL_RUN_TMNUM
DEF SUBMISSION_TMNUM  EQU SUPERPOWER_TMNUM
...
DEF RAGE_TMNUM        EQU DRAIN_PUNCH_TMNUM
DEF BIDE_TMNUM        EQU BODY_PRESS_TMNUM
DEF TM_RAZOR_WIND  EQU TM_X_SCISSOR
DEF TM_WHIRLWIND   EQU TM_ROOST
DEF TM_HORN_DRILL  EQU TM_DRILL_RUN
DEF TM_SUBMISSION  EQU TM_SUPERPOWER
...
DEF TM_RAGE        EQU TM_DRAIN_PUNCH
DEF TM_BIDE        EQU TM_BODY_PRESS
