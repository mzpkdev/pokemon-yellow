...
; Mt. Moon events
	...
	const_skip
	const EVENT_BEAT_MT_MOON_B1F_TRAINER_0
	const EVENT_GOT_DOME_FOSSIL
	const_skip 6 ; added to keep Mt Moon 3 Trainers Working
...
; arbitrary flags
	...
	const EVENT_LOST_TO_LT_SURGE_WITH_STARTER_PIKACHU
