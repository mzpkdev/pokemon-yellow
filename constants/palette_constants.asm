...
; PAL_SET supports 9-bit palette indexes. Keep the existing normal palettes at
; their current IDs and place the additional shiny palettes above the byte range.
	const_def $100
