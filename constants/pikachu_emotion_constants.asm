; pikachu happiness modifiers
	...
	const_def 1
	const PIKACOMPANION_REACTION_BOLT
	const PIKACOMPANION_REACTION_SMILE
	const PIKACOMPANION_REACTION_HEART
	const PIKACOMPANION_REACTION_GYM_VICTORY
	const PIKACOMPANION_REACTION_GIFT_READY
	const PIKACOMPANION_REACTION_AMBIENT_FIND
	const PIKACOMPANION_REACTION_PORTRAIT_READY

DEF PIKACHU_PENDING_EMOTION_MASK EQU %01111111
DEF PIKACHU_PENDING_EMOTION_ALERTED_F EQU 7

	const_def 1
	const PIKACHU_PENDING_CAUGHT_MON
	const PIKACHU_PENDING_FISHING
	const PIKACHU_PENDING_UNUSED
	const PIKACHU_PENDING_EVOLUTION_REFUSAL
	const PIKACHU_PENDING_ELECTRIC_MOVE
	const PIKACHU_PENDING_SIGHTING

DEF PIKACHU_GIFT_COOLDOWN_STEPS EQU 128

DEF PIKACHU_EVOLUTION_HAPPINESS EQU 200

	const_def
	const PIKACHU_EVOLUTION_ROUTE_NONE
	const PIKACHU_EVOLUTION_ROUTE_SURGE
	const PIKACHU_EVOLUTION_ROUTE_FUJI
; Try every 64 eligible steps with a 1-in-8 chance: 512 steps on average.
DEF PIKACHU_AMBIENT_FIND_STEP_MASK   EQU %00111111
DEF PIKACHU_AMBIENT_FIND_CHANCE_MASK EQU %00000111
