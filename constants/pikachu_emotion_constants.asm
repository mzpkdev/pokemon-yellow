...
; Debug tuning: try every 8 eligible steps and always find an item.
DEF PIKACHU_AMBIENT_FIND_STEP_MASK   EQU %00000111
DEF PIKACHU_AMBIENT_FIND_CHANCE_MASK EQU %00000000
