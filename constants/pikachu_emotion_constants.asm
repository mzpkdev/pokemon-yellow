...
; Debug tuning: try every 32 eligible steps with a 1-in-4 chance.
DEF PIKACHU_AMBIENT_FIND_STEP_MASK   EQU %00011111
DEF PIKACHU_AMBIENT_FIND_CHANCE_MASK EQU %00000011
