...
Write pull request descriptions as a human-facing pitch for the feature.
...
Adapt the structure to the change. Use headings and tables when they genuinely improve readability, but do not force every pull request into the same template. Small maintenance changes may use a proportionally shorter description.
