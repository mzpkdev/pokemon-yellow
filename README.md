...
- JojoBear13/ShinPokeRed- Trainer AI code taken from game, Sound Test Option, Color Attacks/Pokeballs, Coin Observer, as well as many many bug fixes. TRY SHINPOKERED. AS I STATED BEFORE ITS IN TOP 3 OF GEN 1 HACKS.
