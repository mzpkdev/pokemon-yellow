...
; Jessie & James
	...
	db $FF, 33, MEOWTH, 31, ARBOK, 30, LICKITUNG, 31, WEEZING, 0 ; PokĂ©mon Tower 7F
...
; Rematch
	db $FF, 83, CLEFABLE, 83, MUK, 82, SLOWBRO, 84, HITMONLEE, 84, RHYDON, 85, MACHAMP, 0

BrockData:
	db $FF, 10, GEODUDE, 12, ONIX, 0
	db $FF, 74, OMASTAR, 75, ONIX, 74, KABUTOPS, 74, GOLEM, 74, NINETALES, 75, AERODACTYL, 0

MistyData:
	db $FF, 19, PSYDUCK, 18, GOLDEEN, 21, STARMIE, 0
	db $FF, 74, SEADRA, 75, GOLDUCK, 74, LAPRAS, 74, BLASTOISE, 74, VAPOREON, 75, STARMIE, 0

LtSurgeData:
	db $FF, 29, RAICHU, 0
	db $FF, 74, ELECTRODE, 75, MAGNETON, 74, JOLTEON, 74, PORYGON, 74, ELECTABUZZ, 75, RAICHU, 0
...
ErikaData:
	...
	db $FF, 74, TANGELA, 74, VENUSAUR, 74, PARASECT, 74, EXEGGUTOR, 75, VICTREEBEL, 75, VILEPLUME, 0

KogaData:
	db $FF, 42, GOLBAT, 42, MUK, 41, TENTACRUEL, 43, VENOMOTH, 0
	db $FF, 49, GOLBAT, 48, MUK, 49, TENTACRUEL, 48, WEEZING, 50, VENOMOTH, 0
	db $FF, 74, GOLBAT, 74, MUK, 74, TENTACRUEL, 75, WEEZING, 74, ARBOK, 75, VENOMOTH, 0

BlaineData:
	db $FF, 52, RAPIDASH, 51, CHARIZARD, 51, NINETALES, 52, ARCANINE, 53, MAGMAR, 0
	db $FF, 74, RAPIDASH, 74, FLAREON, 74, CHARIZARD, 74, NINETALES, 75, ARCANINE, 75, MAGMAR, 0

SabrinaData:
	db $FF, 50, ABRA, 48, HYPNO, 49, MR_MIME, 50, KADABRA, 50, ALAKAZAM, 0
	db $FF, 43, ABRA, 42, MR_MIME, 43, KADABRA, 43, ALAKAZAM, 0
	db $FF, 75, MR_MIME, 74, HYPNO, 74, SLOWBRO, 74, JYNX, 74, GENGAR, 75, ALAKAZAM, 0
...
; Rematch
	db $FF, 90, ALAKAZAM, 89, MACHAMP, 88, GYARADOS, 87, PIDGEOT, 88, EXEGGUTOR, 90, ARCANINE, 0

LoreleiData:
	db $FF, 56, SLOWBRO, 55, CLOYSTER, 55, DEWGONG, 56, JYNX, 57, LAPRAS, 0
; Rematch
	db $FF, 82, WIGGLYTUFF, 83, STARMIE, 83, CLOYSTER, 82, OMASTAR, 82, EXEGGUTOR, 85, LAPRAS, 0
...
; Rematch
	db $FF, 82, JYNX, 82, GYARADOS, 84, ALAKAZAM, 82, VENUSAUR, 84, ARBOK, 85, GENGAR, 0

LanceData:
	db $FF, 61, DRAGONITE, 60, GYARADOS, 60, CHARIZARD, 61, AERODACTYL, 62, DRAGONITE, 0
; Rematch
	db $FF, 83, ARCANINE, 83, ELECTABUZZ, 84, SNORLAX, 84, CHARIZARD, 82, KANGASKHAN, 85, DRAGONITE, 0
